...
export function AboutSection() {
  ...
  return (
    <section id="about" ref={ref} className="portfolio-section">
      ...
      <motion.div
        className="absolute left-[7%] top-1/2 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-2xl border border-indigo-400/25 bg-indigo-400/5 text-indigo-300 md:flex"
      ...
      <div className="portfolio-container grid items-center gap-8 lg:grid-cols-[minmax(0,0.92fr)_minmax(340px,560px)] lg:gap-14">
        <motion.div
        ...
        <motion.div
          ...
          className="relative min-h-[500px] w-full max-w-[560px] justify-self-center lg:justify-self-end"
        >
          <motion.div
          ...
          >
            ...
            <div className="relative z-10 flex h-20 items-center border-b border-indigo-500/30 px-6 sm:px-8">
            ...
            <div className="relative z-10 overflow-x-auto px-5 py-6 font-mono text-[11px] leading-[1.68] text-slate-300 sm:px-8 sm:text-[12px] md:text-[13px]">
          ...
          {floatingTags.map((tag, index) => (
            <motion.div
              key={tag.label}
              className={`absolute z-20 hidden items-center gap-3 rounded-xl border border-white/10 bg-black/80 px-5 py-4 shadow-2xl shadow-black/40 backdrop-blur-xl md:flex ${tag.className}`}
